...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas líneas contienen los mensajes de error por defecto que usa la clase
    | validadora. Algunas reglas tienen varias versiones (numeric, string, etc.).
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute apareció en una filtración de datos. Elige uno diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Traduce los nombres de campo para que los mensajes se lean naturales
    | (p. ej. "El campo Correo electrónico es obligatorio").
    |
    */
    ...
    'attributes' => [
        ...
        'comuna' => 'comuna',
        'monto' => 'monto',
        'habilidad_vida' => 'habilidad para la vida',
