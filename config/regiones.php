...
|--------------------------------------------------------------------------
|
| Mapa Región => [comunas] para los selectores dependientes del formulario de
| inscripción (elegir región filtra las comunas). Ordenado de norte a sur.
| La Región Metropolitana reutiliza el mismo listado que config/comunas.php.
|
*/
...
return [
    ...
    'Valparaíso' => [
        ...
        'La Calera', 'La Cruz', 'La Ligua', 'Limache', 'Llaillay', 'Los Andes', 'Nogales',
        'Olmué', 'Panquehue', 'Papudo', 'Petorca', 'Puchuncaví', 'Putaendo', 'Quillota',
        'Quilpué', 'Quintero', 'Rinconada', 'San Antonio', 'San Esteban', 'San Felipe',
