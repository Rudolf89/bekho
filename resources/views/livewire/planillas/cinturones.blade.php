...
<div class="mx-auto w-full max-w-4xl space-y-6">
    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-3 text-sm text-zinc-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
        ...
        <p class="mt-1 text-zinc-500 dark:text-zinc-400">El plan de clase rota semana a semana, así que en los cinturones altos (Verde a Rojo) las patadas BEKHO se listan <span class="font-semibold">por banda</span> (nivel de clase); el grado exacto está por afinar.</p>
    </div>
